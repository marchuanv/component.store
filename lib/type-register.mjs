...
export class TypeRegister extends Store {
    ...
    */
    get(prototype) {
        ...
        if ((prototype === null && data === null) || (prototype === undefined && data === undefined)) {
            return data;
        } else if (prototype === null || prototype === undefined) {
            throw new Error(`The data type does not match the prototype argument.`);
        }
        const _type = prototype.constructor;
        if (!Reflection.isPrimitiveType(_type) && !Reflection.isClass(_type)) {
            throw new Error('invalid type argument.');
        }
        if (!(data instanceof _type)) {
            throw new Error(`The data type does not match the argument type.`);
        }
        return data;
    }
    /**
