...
export class Store extends GUID {
    ...
    */
    constructor(metadata, secureContext, schema) {
        ...
        if (getMethod === undefined || setMethod === undefined || extendedProperty === undefined) {
            throw new Error(`${directStoreExtendClass.name} requires overriding get() and set() methods and an overriding get property called extended.`);
        }
        super(metadata);
