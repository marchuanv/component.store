import { GUID, Reflection, TypeDecorator, TypeMemberDecoratorSchema } from '../registry.mjs';
/**
...
export class TypeMemberDecorator extends TypeDecorator {
    ...
    */
    constructor(type, typeDecoratorId = null, memberName = "", memberType) {
        ...
        if (typeDecoratorId === null || typeDecoratorId === undefined) {
            ...
            if (memberType === null || memberType === undefined || memberType) {
